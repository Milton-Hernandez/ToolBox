    ...
    public class AssemblyReflector
    {
        ...
        static AssemblyReflector()
        {
            ...
            foreach (var a in assemblies)
            {
                ...
                {
                    AssemblyDictionary[key] = new AssemblyReflector(a);
        ...
        public static AssemblyReflector Get(string name)
        {
        ...
        public static string LoadFromFile(string path)
        {
            ...
            string key = AssemblyToLoad.GetName().Name;
            if (!AssemblyDictionary.ContainsKey(key))
        ...
        public TypeReflector this[string ClassName]
        {
            get
            {
                string fullName = ClassName + ", " + _assembly.GetName();
                Type ConfigType = Type.GetType(fullName);
                return new TypeReflector(ConfigType);
            }
        }
    }
